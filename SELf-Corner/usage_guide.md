...
| 回饋內容 | AI 教練依 KIST 12 張對話卡框架提供的條列式改進建議 |
| 回顧討論 | 可與 AI 教練進行文字問答；教練擁有完整逐字稿與報告內容作為知識背景 |
| 對話紀錄 | 完整師生逐字稿，支援「完整對話」與「分開檢視」兩種檢視模式 |
| 重試/回首頁 | 可直接重練相同情境或返回首頁 |

### 5.5 歷史紀錄頁（`/history`）

- 顯示所有已結束的練習 Session
- 支援依情境名稱或日期搜尋
- 點擊有「有報告」標籤的記錄，可跳轉至該次的回饋報告
