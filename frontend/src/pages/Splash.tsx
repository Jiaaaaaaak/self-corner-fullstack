...
export default function Splash() {
  ...
  return (
    <div className="fixed inset-0 bg-[#FAF9F6] flex flex-col items-center justify-center px-6 overflow-hidden">
      {/* 背景柔和光暈 */}
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md">
        ...
        <div className="animate-in fade-in zoom-in-95 duration-700">
          <img
            ...
            alt="SELf-Corner"
            className="w-40 md:w-48 h-auto mb-8 drop-shadow-sm"
            onError={(e) => {
        ...
        {/* Brand name */}
        <h1
          className="font-heading text-4xl md:text-5xl font-bold text-[#3D3831] tracking-tight mb-3 animate-in fade-in slide-in-from-bottom-2 duration-700"
        ...
        >
          {showButtonSpinner ? (
            <>
              ...
              <span className="tracking-widest text-sm">準備中</span>
            </>
          ) : (
            <>
        ...
        {/* 底部小字 */}
        <p
          className="absolute bottom-8 left-1/2 -translate-x-1/2 text-[10px] text-[#A09C94] font-medium tracking-[0.2em] uppercase animate-in fade-in duration-1000"
